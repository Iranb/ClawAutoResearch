...
This project is indexed by GitNexus as **ClawAutoResearch** (33808 symbols, 54175 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
