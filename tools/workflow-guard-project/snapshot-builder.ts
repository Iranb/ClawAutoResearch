...
export async function buildWorkflowSnapshotFromProjectState(
  ...
  > = {
    ...
    benchmarkProtocolPrimaryMetric: benchmarkProtocol.primaryMetric,
    benchmarkProtocolSplitDescriptor: benchmarkProtocol.splitDescriptor,
    benchmarkProtocolEvaluationHarness: benchmarkProtocol.evaluationHarness,
    benchmarkProtocolFairCompareStatus: benchmarkProtocol.fairCompareStatus,
    benchmarkProtocolFairCompareSummary: benchmarkProtocol.fairCompareSummary,
    benchmarkProtocolAllowedDeviationCount: benchmarkProtocol.allowedDeviationCount,
    benchmarkProtocolAllowedDeviationStatus: benchmarkProtocol.allowedDeviationStatus,
    benchmarkProtocolFairnessReportPath: benchmarkProtocol.fairnessReportPath,
