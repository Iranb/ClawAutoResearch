...
This project is indexed by GitNexus as **ClawAutoResearch** (33671 symbols, 53940 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
