...
This project is indexed by GitNexus as **ClawAutoResearch** (30671 symbols, 48656 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
