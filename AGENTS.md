...
This project is indexed by GitNexus as **ClawAutoResearch** (33614 symbols, 53796 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
