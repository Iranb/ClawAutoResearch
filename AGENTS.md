...
This project is indexed by GitNexus as **ClawAutoResearch** (33945 symbols, 54367 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
