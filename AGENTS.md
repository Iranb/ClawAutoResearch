...
This project is indexed by GitNexus as **ClawAutoResearch** (30246 symbols, 47889 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
