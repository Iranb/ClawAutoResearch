...
- At terminal closeout, use `research_workflow.materialize_workflow_final_scorecard` to refresh `.openclaw-research/WORKFLOW_FINAL_SCORECARD.json`; this is a derived diagnostic summary, not a completion authority.
