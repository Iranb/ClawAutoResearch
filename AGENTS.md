...
This project is indexed by GitNexus as **ClawAutoResearch** (30430 symbols, 48213 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
