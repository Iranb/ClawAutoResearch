...
- `skills/papernexus-idea-catalyst/SKILL.md`

And exactly one canonical script entry:

- `skills/papernexus-idea-catalyst/scripts/pn_idea_catalyst.py`
...
```bash
python3 skills/papernexus-idea-catalyst/scripts/pn_idea_catalyst.py \
  --corpus "<corpus>" \
